...
<!--[if gt IE 8]><!--> <html class="no-js" lang="en"> <!--<![endif]-->
	...
	<body class="single-page single-project">
		...
		<div class="big-parent">
			...
			<section class="main-section center-block detail-container padtop-50">
				...
				<div class="txt-center detail-intro">
					<hgroup>
						<h1>Vulcania Concretos</h1>
						<h4>
							<a href="#">Branding</a>, <a href="#">Website</a>
						</h4>
						<h2>I was hired by my friends at Ovis in order to help them give a much needed refresher to the Vulcania Concretos brand.</h2>
					</hgroup>
				</div>
				<!-- //INTRO -->
				<article class="detail-content">
					<img src="images/img-project.jpg" alt="">
				</article>
				<div class="pager">
					<a href="index.php" class="left nav">
						<img class="svg" src="images/arrow-left.svg" alt="Previous Page">
					</a>
					<a href="index.php" class="right nav"><img class="svg" src="images/arrow-right.svg" alt="Next Page"></a>
				</div>
			</section>
			<!-- //INTRO -->
			<!-- FOOTER -->
